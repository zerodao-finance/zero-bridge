        ...
        <ConversionToolContext.Consumer>
            { value =>
                ...
                <div className="flex flex-row">
                    <input type="number" step="1" className="form-input appearance-none rounded-md ring-1 ring-emerald-300 text-center focus:ring-0 border-0 w-16 min-w-16 mr-10 py-1 font-medium text-lg tracking-wide" value={value.get.ratio} onChange={value.set.ratioInput}/>
