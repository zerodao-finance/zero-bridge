            ...
            { value =>
                <div className="flex flex-col gap-2 self-center text-black dark:text-white">
                    <div className="flex flex-row w-full justify-between items-center px-5 gap-2">
                        ...
                        <span className="flex items-center font-bold"><p className="text-xs">{`${100-value.get.ratio}%`}</p><FaBtc className="fill-gray-900 dark:fill-gray-300 h-[1.3rem] w-max"/></span> 
                    </div>
                </div>
            }
        </ConversionToolContext.Consumer>
