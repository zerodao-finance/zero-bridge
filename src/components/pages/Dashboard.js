...
const Dashboard = () => {
  ...
  return (
    <div className="bg-gradient-to-tl from-rose-50 to-teal-50 dark:bg-none dark:bg-gradient-to-br dark:from-gray-700 dark:via-gray-900 dark:to-black h-screen">
      <header>
        <AppBar />
