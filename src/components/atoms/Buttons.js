const Button = ({text, variant, action}) => {
    const variants = {
        "outlined": "border-2 rounded-full px-3 py-1 border-red-200 text-red-500 transition-all duration-100 hover:scale-110 hover:text-white hover:bg-emerald-300 hover:border-green-300 text-xl h-fit",
