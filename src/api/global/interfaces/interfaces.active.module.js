...
export const useActiveModuleSwitcher = () => {
    ...
    const changeActiveModule = (module) => {
        dispatch({ type: "SUCCEED_REQUEST", effect: "module", payload: { effect: "currentModule", data: module}})
    }
    ...
    useEffect(() => {
        if (isLoading) {
            dispatch({ type: "SUCCEED_REQUEST", effect: "module", payload: { effect: "currentModule", data: "bridge"}})
        }
    }, [isLoading])
