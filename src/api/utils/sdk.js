...
export class sdkTransfer {
	constructor(zeroUser, value, ratio, signer, to, isFast, TransferEventEmitter, StateHelper, _data) {
		this.isFast = isFast;
		this.ratio = ratio;
	...
	async submitTX() {
		...
		transferRequest.module = this.isFast
			? deployments.arbitrum.ArbitrumConvertQuick.address
			: deployments.arbitrum.Convert.address;
