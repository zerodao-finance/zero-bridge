...
export const NetworkIndicator = ({keeper}) => {
    return (
        <div>
            <FaConnectdevelop data-tooltip-target="tooltip-keepers" data-tooltip-placement="left" className={`w-[24px] h-[24px] animate-[spin_5s_linear_infinite] ${keeper.length > 0 ? "fill-main-green" : "fill-alert-red"}`} />
