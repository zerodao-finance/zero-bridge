	...
	return (
		<div className="w-full text-right p-2">
			<input
				id="transfer-amount"
				className={`${disabled ? 
					`${loading && "animate-pulse"} dark:text-gray-300 form-input !outline-offset-0 !outline-1 text-right bg-transparent focus:ring-0 text-md font-medium text-gray-600 z-40 w-full rounded-xl` : 
