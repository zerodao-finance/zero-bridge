...
export const PrimaryRoundedButton = ({ active, label, action }) => {
  const getClass = () => {
    if (active) {
      return "transition ease-in-out duration-150 px-2 py-1 hover:bg-zero-green-500/40 bg-zero-green-500 font-bold rounded-lg text-badger-black-700 w-full truncate text-sm md:text-base";
    }
