    ...
    <nav className="space-y-8" aria-label="Sidebar">
       ...
       */}
        <div className="flex flex-row gap-3 ">
            <RiExchangeFundsLine className="h-[1.2rem] w-[1.2rem] dark:fill-white"/>
        ...
        <div className="flex flex-row gap-3 ">
            <MdOutlinePending className="h-[1.2rem] w-[1.2rem] dark:fill-white"/>
        ...
        <div className="flex flex-row gap-3 ">
            <BiTransfer className="h-[1.2rem] w-[1.2rem] dark:fill-white"/>
        ...
        <div className="flex flex-row gap-3 ">
            <RiFileListLine className="h-[1.2rem] w-[1.2rem] dark:fill-white"/>
