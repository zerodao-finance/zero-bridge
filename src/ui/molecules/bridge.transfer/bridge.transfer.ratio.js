    ...
    return (
        <div className="flex flex-col gap-2 self-center text-black dark:text-white scale-[0.8] md:scale-[1]">
            <div className="flex flex-row w-full justify-between items-center px-5 gap-2">
                ...
                <input type="range" className="z-40 overflow-hidden form-range cursor-pointer appearance-none h-1 focus:outline-none focus:ring-0 focus:shadow-none rounded-full bg-slate-400 w-[15rem]" id="range_select" name="ratio" min="0" max="100" step="1" value={ratio} onChange={effect}/>
